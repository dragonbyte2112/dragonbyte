    ...
    <div className="page-enter">
      ...
      <div style={{ padding: '0 2rem 2rem', maxWidth: 600, margin: '0 auto' }}>
        <div style={{ background: '#071a0e', border: '1px solid #0f3020', borderTop: '3px solid #ff2040', borderRadius: 6, padding: '2rem', display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
          <div style={{ width: 80, height: 80, borderRadius: '50%', background: 'linear-gradient(135deg,#cc0020,#660010)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.8rem', flexShrink: 0, border: '2px solid #ff2040' }}>
            🐉
          </div>
          <div>
            <div style={{ fontFamily: 'Orbitron,monospace', fontSize: '1rem', color: '#b0ffcc', letterSpacing: '2px' }}>DragonByte Founder</div>
            <div style={{ fontFamily: '"Share Tech Mono",monospace', fontSize: '0.65rem', color: '#ff2040', letterSpacing: '2px', margin: '4px 0 8px' }}>// FOUNDER &amp; LEAD</div>
            <div style={{ fontSize: '0.85rem', color: '#3a7a50', lineHeight: 1.5 }}>
              Passionate about cybersecurity, CTFs, and building a community where no one has to learn alone. Started DragonByte to create the team they always wished they had.
            </div>
          </div>
        </div>
      </div>
